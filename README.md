...
GitHub: https://github.com/hinakkograshi/HinakkoShopping/tree/develop

Build@Mercari Training Program 2024終了後、サンプルアプリを作成しました。

SwiftUIとAPI通信の学習のために、今回作成したGoAPIとAPI通信を行うサンプルアプリです。
